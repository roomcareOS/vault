...
- [[Verify before you correct published copy]] — an agent's fact-check is evidence, not a verdict: five of sixteen "errors" in the 16 Aug 2026 sweep were wrong, and absence claims ("the figure is not in the document") are the least reliable of all. Carries the two-pass rule, the corrections shape, and the trap in machine-applying fixes.
