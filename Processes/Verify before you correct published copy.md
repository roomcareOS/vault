...
5. **Correct in the open.** Fix the text, append a dated italic note at the foot, set `updated:`. Nine articles carry such notes from this sweep. Never silently rewrite a published claim.
